              ...
              {Object.entries(menuByCategory).map(([category, items]) => (
                <div key={category} className="mb-8">
                  <h4 className="text-md font-semibold text-gray-800 mb-4 capitalize">
                    {category === 'food' ? 'Pratos' : category === 'drink' ? 'Bebidas' : 'Sobremesas'}
                  </h4>
                    ...
                    {items.map((item) => (
                      <div key={item.id} className="border border-gray-200 rounded-lg p-4 hover:shadow-md transition-shadow">
                        <div className="flex justify-between items-start mb-2">
                          ...
                          <span className="text-sm font-bold text-green-600">R$ {item.price.toFixed(2)}</span>
                        </div>
                        {item.description && (
            ...
            <div className="bg-white shadow rounded-lg">
              <div className="px-4 py-5 sm:p-6">
                ...
                <div className="space-y-4">
                  ...
                  {(orderData.type === 'delivery' || orderData.type === 'takeout') && (
                    <>
                      <div>
                        <label className="block text-sm font-medium text-gray-700 mb-2">
                          Nome do Cliente
                  ...
                  <div className="space-y-3">
                    ...
                    <div className="pt-4 border-t border-gray-200">
                      <div className="flex justify-between items-center mb-4">
                        ...
                        <span className="text-lg font-bold text-green-600">R$ {getTotal().toFixed(2)}</span>
                      </div>
