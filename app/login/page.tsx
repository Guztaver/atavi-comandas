      ...
      <div className="bg-white rounded-2xl shadow-xl p-8 w-full max-w-md">
        ...
        <div className="mt-8 pt-6 border-t border-gray-200">
          <div className="text-center text-sm text-gray-500">
            <p className="mb-2">Usuários disponíveis:</p>
            <div className="space-y-1 text-xs">
              <p>• <span className="font-medium">admin</span> / 123456</p>
              <p>• <span className="font-medium">cozinha</span> / cozinha123</p>
              <p>• <span className="font-medium">delivery</span> / delivery123</p>
            </div>
          </div>
        </div>
      </div>
