...
CREATE TABLE `menu_items` (
	...
	`created_at` text DEFAULT '2025-11-13T11:37:22.436Z' NOT NULL,
	`updated_at` text DEFAULT '2025-11-13T11:37:22.437Z' NOT NULL
);
--> statement-breakpoint
CREATE TABLE `order_items` (
	...
	`price` real NOT NULL,
	`notes` text,
	`created_at` text DEFAULT '2025-11-13T11:37:22.437Z' NOT NULL,
